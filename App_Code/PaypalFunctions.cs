...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
     ...
     /*   using (FinalAmt.Logic.ShoppingCartActions myCartOrders = new WingtipToys.Logic.ShoppingCartActions())
        {
...
public sealed class NVPCodec : NameValueCollection
{
    ...
    public string APIUsername = "ashish7792_api1.gmail.com";
    private string APIPassword = "G7VHVYGL4G5B73V5";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AsWEqIfz4.sXR12iyOu-pcL95sXb";
